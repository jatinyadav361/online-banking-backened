...
public interface TransactionRepository extends JpaRepository<Transaction, Long> {
	...
	@Query("select t.transactionId from Transaction t where t.senderAccount.accountNo=?1 or (t.recieverAccount != null and t.recieverAccount.accountNo=?1) order by t.timestamp desc")
	public List<Long> fetchAllTransactions(long accountId);
